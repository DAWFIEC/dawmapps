...
* **[`hito8-api`](https://github.com/DAWFIEC/DAWM-apps/tree/hito8-api)** Implementación del API REST del modelo ALBUM, según las instrucciones de [Express - REST](https://dawfiec.github.io/DAWM/tutoriales/express_rest.html).
